...
export const navLinks: NavLink[] = [
  ...
  },
  {
    ...
    columns: 2,
    services: [
      { name: 'UAE Company Registration', path: '/services/global/uae-company-registration' },
      { name: 'USA Company Registration', path: '/services/global/usa-company-registration' },
      { name: 'Singapore Company Registration', path: '/services/global/singapore-company-registration' },
      { name: 'UK Company Registration', path: '/services/global/uk-company-registration' },
    ...
    >
      ...
      >
        ...
        <div className="hidden xl:flex items-center flex-grow justify-center min-w-0">
          <div className="flex items-center justify-center gap-0.5 xl:gap-1 2xl:gap-2">
            {navLinks.map((link) => (
              <div
                key={link.name}
              ...
              >
                <Link
                  to={link.path}
                  className={cn(
                    'px-1 xl:px-1.5 2xl:px-2.5 py-4 text-xs xl:text-[13px] 2xl:text-[15px] font-bold tracking-normal transition-all duration-300 flex items-center gap-0.5 whitespace-nowrap',
                    isLinkActive(link)
