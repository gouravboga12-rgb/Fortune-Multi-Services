                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="md:col-span-2 relative">
                      <input
                        ...
                        required
                        className="w-full h-16 pl-6 pr-4 bg-white border border-light-gray focus:border-accent rounded-2xl outline-none text-primary font-bold placeholder-dark-gray/30 transition-colors shadow-sm"
                      />
                    </div>
                    <div>
                      <select
                        ...
                        className="w-full h-16 px-6 bg-white border border-light-gray focus:border-accent rounded-2xl outline-none text-primary font-bold cursor-pointer shadow-sm"
                      >
              ...
              {status === 'checking' && (
                ...
                >
                  <div className="flex flex-col items-center justify-center text-center space-y-4">
                    ...
                    <h3 className="text-xl font-bold text-primary">Analyzing Name Registries</h3>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-left min-w-0">
                            <div className={`text-sm font-bold ${isDone ? 'text-emerald-600' : 'text-primary'}`}>{step.label}</div>
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row items-center sm:justify-between gap-6 pb-6 border-b border-light-gray">
                    <div className="text-center sm:text-left space-y-1">
                      ...
                      <h3 className="text-2xl font-black text-primary pt-2">"{fullName}"</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                      ...
                      <div key={card.title} className="p-6 bg-white border border-light-gray rounded-2xl space-y-3">
                        <div className="flex items-center justify-between">
                          <h4 className="text-xs font-black text-primary/40 uppercase tracking-wider">{card.title}</h4>
                          <card.icon className="w-5 h-5 text-emerald-500" />
                        </div>
                        <div className="text-base font-black text-primary">{card.status}</div>
