    ...
    <div className="bg-soft-white min-h-screen">
            ...
            <div className="lg:col-span-2 space-y-20">
              ...
              >
                <div className="flex items-center gap-4 mb-10">
                  ...
                  <h2 className="text-3xl font-black text-primary">Service Catalog</h2>
                </div>
                  ...
                  {category.services.map((service, i) => {
                    return (
                      <Link 
                        ...
                        className={`block glass-card p-8 group transition-all duration-500 hover:border-accent/30 hover:shadow-lg`}
                      >
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <ArrowRight className={`w-5 h-5 text-accent opacity-0 group-hover:opacity-100 transition-opacity -translate-x-4 group-hover:translate-x-0`} />
                        </div>
              ...
              >
                <div className="flex items-center gap-4 mb-12">
                  ...
                  <h2 className="text-3xl font-black text-primary">The Engagement Flow</h2>
                </div>
      ...
      <section className="py-24 bg-white border-t border-light-gray">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <h2 className="text-3xl font-black text-primary mb-12">Explore Other Excellence Areas</h2>
