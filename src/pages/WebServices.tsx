...
const WebServices = () => {
  return (
    <div className="bg-soft-white min-h-screen">
      ...
      {/* ── Our Web Solutions ── */}
      <section id="solutions" className="py-12 sm:py-20 lg:py-28">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-primary tracking-tight">Our Web Solutions</h2>
          ...
          >
            {solutions.map((s, i) => (
              ...
              >
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center border ${s.color} bg-white shadow-sm group-hover:scale-110 transition-transform`}>
                  <s.icon className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="text-lg sm:text-xl font-black text-primary mb-2">{s.title}</h3>
      ...
      <section className="py-12 sm:py-20 lg:py-28 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-primary tracking-tight">Our Technology Stack</h2>
            <div className="w-20 h-1 bg-accent mx-auto rounded-full"></div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {techStack.map((tech, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className={`p-5 sm:p-7 rounded-2xl border ${tech.color} bg-white shadow-sm hover:shadow-premium transition-all`}
              >
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center border mb-4 ${tech.color}`}>
                  <tech.icon className="w-5 h-5" />
                </div>
                <h3 className="text-sm font-black text-primary uppercase tracking-wider mb-3">{tech.label}</h3>
      ...
      <section className="py-12 sm:py-20 lg:py-28 bg-soft-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-primary tracking-tight">Our Development Lifecycle</h2>
            <div className="w-20 h-1 bg-accent mx-auto rounded-full"></div>
          </motion.div>
          ...
          <div className="relative pl-6 sm:pl-10 border-l-2 border-accent/20 ml-3 sm:ml-6 space-y-6 sm:space-y-8 max-w-3xl mx-auto">
            {lifecycle.map((phase, i) => (
              ...
              >
                <div className="absolute -left-[35px] sm:-left-[51px] top-1 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-primary flex items-center justify-center text-white text-[10px] sm:text-xs font-black border-4 border-soft-white group-hover:bg-accent transition-colors shadow">
                  {phase.num}
                </div>
                <div className="glass-card p-5 sm:p-7 bg-white/90 group-hover:border-accent/30 group-hover:translate-x-1 transition-all">
                  <h3 className="text-base sm:text-xl font-black text-primary mb-1">{phase.title}</h3>
      ...
      <section className="py-12 sm:py-20 lg:py-28 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-primary tracking-tight">Hosting &amp; Deployment Options</h2>
            <div className="w-20 h-1 bg-accent mx-auto rounded-full"></div>
          </motion.div>
            ...
            {hosting.map((plan, i) => (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <h3 className={`text-lg sm:text-xl font-black ${plan.highlight ? 'text-white' : 'text-primary'}`}>
                    {plan.label}
                  </h3>
                ...
                <Link
                  ...
                  className={`mt-6 flex items-center justify-center gap-2 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${
                    plan.highlight
                      ...
                      : 'border border-light-gray text-primary hover:border-accent hover:text-accent'
                  }`}
                >
